...
- ใช้ `pwd`, `ls`, `ls -a`, `cd`, `mkdir` และ `clear` สำรวจ filesystem
...
หนังสือและบทเรียน Git ส่วนใหญ่ยังสอน command line เพราะมันช่วยสร้าง **mental model** หรือภาพในหัวว่า Git ทำงานอย่างไร 
ถ้าเข้าใจ command line แล้ว จะไปใช้ GitHub Desktop, VS Code หรือ GUI ตัวไหนก็ได้ทั้งนั้น
...
> `pwd` บอกว่าเราอยู่ไหน ส่วน `ls` บอกว่ารอบตัวเรามีอะไรอยู่บ้าง จำสองคำนี้ไว้ก่อน ได้ใช้บ่อยมากกกก
