...
> เห็น `.git` แล้วจำง่าย ๆ ว่า: ไฟล์โปรเจกต์อยู่บนโต๊ะ ส่วน `.git` คือห้องเก็บสมุดบันทึกของ Git
...
ลองนึกถึงโต๊ะส่งของ เราอาจมีของอยู่เต็มห้อง แต่ก่อนเรียกคนมารับ เราจะเลือกเฉพาะของที่พร้อมส่งมาวางรวมกันในจุดหนึ่งก่อน staging area ก็ทำหน้าที่คล้ายกัน
...
ถ้าอยากสร้าง repository ซ้อนกันจริง ๆ ต้องรัน `git init` ในโฟลเดอร์ย่อย ซึ่งเป็นเรื่องที่ควรเลี่ยงในช่วงเริ่มต้น เพราะจะทำให้ไม่แน่ใจว่า Git กำลังอ่าน `.git` ของโฟลเดอร์ไหน
